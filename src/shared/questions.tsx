...
export const QUESTION_LIST: Array<IQuestionList> = [
    {
        ...
        questions: [
            ...
            },
            {
                ...
                answer: <div>
                    WildHacks 2024 will take place from <span>Friday, April 4, 2025</span>{' '}
                    to <span>Sunday, April 6, 2025</span>. However, hacking won't start
        ...
        questions: [
            {
                ...
                answer: <div>There will be a room reserved overnight dedicated to sleeping on
                    ...
                    and go from the event as you please.</div>
            },
            {
        ...
        questions: [
            {
                ...
                answer: <div>Send us an email at <a href="mailto:wildhacks@northwestern.edu">wildhacks@northwestern.edu</a>! We'd be happy to answer any questions about the event or steps to get involved.</div>
            },
            {
                question: "I'm interested in sponsoring WildHacks. Who should I contact?",
                answer: <div>Send us an email at <a href="mailto:wildhacks@northwestern.edu">wildhacks@northwestern.edu</a>! We'd be happy to talk!</div>
            },
        ]
    }
];
