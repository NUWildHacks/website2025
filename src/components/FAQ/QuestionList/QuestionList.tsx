...
export const QuestionList: React.FC<IQuestionList> = ({header, questions}) => {
  ...
  return <div className="faq__questionlist">
    <div>
      ...
      <div className="faq__questions_container">
        <div className="faq__questions_column">
          {first_half_of_questions.map((elem, index) => (
            <Question question={elem.question} answer={elem.answer} key={`questionlist_${elem.question}_${index}`} />
          ))}
        </div>
        <div className="faq__questions_column">
